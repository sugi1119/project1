...
a1 = Patient.create(:f_name => 'Yuko', :m_name => '', :l_name => 'Sugiyama', :title => 'Ms', :address => '16 Lamrock Avenue Bondi Beach NSW', :postcode => '2026', :dob => '1234-05-06', :phone => '0293654345', :mobile => '0409655016', :occupation => 'web developer')
